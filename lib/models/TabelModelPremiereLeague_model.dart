...
//
//     final tabelModelPremiereLeague = tabelModelPremiereLeagueFromJson(jsonString);

import 'dart:convert';

TabelModelPremiereLeague tabelModelPremiereLeagueFromJson(String str) => TabelModelPremiereLeague.fromJson(json.decode(str));

String tabelModelPremiereLeagueToJson(TabelModelPremiereLeague data) => json.encode(data.toJson());

class TabelModelPremiereLeague {
    List<Table> table;

    TabelModelPremiereLeague({
        required this.table,
    });

    factory TabelModelPremiereLeague.fromJson(Map<String, dynamic> json) => TabelModelPremiereLeague(
